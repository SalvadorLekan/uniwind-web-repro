...
export default function App() {
  return (
    <View className="flex-1 bg-white dark:bg-black items-center justify-center px-8">
      ...
      {/* Subheading */}
      <Text className="text-xl mm text-test mb-8 text-center leading-relaxed">
        Build beautiful apps with <Text className="text-blue-500 font-semibold">Expo (Router) + Uniwind 🔥</Text>
      </Text>
